...
import matheusrodrigues.androidapps.businesscard.databinding.ItemBusinessCardBinding

class BusinessCardAdapater :
    ListAdapter<BusinessCard, BusinessCardAdapater.ViewHolder>(DiffCallback()) {
